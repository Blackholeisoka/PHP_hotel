...
<body>
    ...
    <div class="container px-4 px-lg-5">
        <div class="row gx-4 gx-lg-5 align-items-center my-5">
            <div class="col-lg-7"><img class="img-fluid rounded mb-4 mb-lg-0" src="https://images6.alphacoders.com/349/349835.jpg" alt="..." /></div>
            <div class="col-lg-5">
                <h1 class="font-weight-light">Luxury Hotel</h1>
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Cum molestias obcaecati alias molestiae odio facilis velit veniam distinctio voluptatum, dicta esse consequuntur delectus iure nobis saepe nulla porro dolore. Quod.</p>
                <a class="btn btn-primary" href="hotels.php">Voir les hôtels !</a>
            </div>
        </div>
